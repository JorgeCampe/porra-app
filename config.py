...
# Cierre GLOBAL de la Fase 2 (eliminatorias): 30 min antes de Brasil-Japón, o sea
# el 29 de junio a las 11:30 de Perú (= 16:30 UTC). Además, cada cruce se bloquea
# 30 min antes de empezar su propio partido.
PHASE2_LOCK_ISO = "2026-06-29T16:30:00"
...
# Emparejamientos OFICIALES de FIFA (verificados con la imagen del cuadro). La
# NUMERACIÓN de huecos se mantiene como cuando la gente predijo, para no voltear sus
# predicciones (se guardan por hueco). OCTAVOS (con los previstos):
#   89 Alemania-Francia   90 Canadá-Holanda   91 Portugal-España   92 EEUU-Senegal/Bélgica
#   93 Brasil-Noruega     94 Ecuador-Inglaterra  95 Argentina-Egipto  96 Suiza-Colombia
BRACKET_FEEDS = {
...
# Horario OFICIAL FIFA por hueco (hora de Perú), para que cada cruce muestre su fecha
# aunque aún no se definan los equipos. (Bracket oficial fifa.com, filtro Perú.)
KO_SCHEDULE = {
    89: "2026-07-04 16:00",  # Alemania-Francia
    90: "2026-07-04 12:00",  # Canadá-Holanda
    91: "2026-07-06 14:00",  # Portugal-España
    92: "2026-07-06 19:00",  # EEUU-Senegal/Bélgica
    93: "2026-07-05 15:00",  # Brasil-Noruega
    94: "2026-07-05 19:00",  # Ecuador-Inglaterra
    95: "2026-07-07 11:00",  # Argentina-Egipto
    96: "2026-07-07 15:00",  # Suiza-Colombia
